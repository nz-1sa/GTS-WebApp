...
export declare namespace DB {
    function addWeblog(uuid: string, requestUrl: string, requestParams: string, responseSuccess: boolean, responseDuration: number, logMessage: string, errorMessage: string): Promise<GTS.WrappedResult<void>>;
    function getWeblogs(uuid: string): Promise<GTS.WrappedResult<Weblog[]>>;
    function pruneWeblogs(uuid: string, id: string): Promise<GTS.WrappedResult<void>>;
}
